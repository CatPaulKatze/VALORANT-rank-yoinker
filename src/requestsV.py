...
class Requests:
    ...
    def check_version(version, copy_run_update_script):
        ...
        try:
            r = requests.get("https://api.github.com/repos/CatPaulKatze/VALORANT-rank-yoinker/releases")
    ...
    def copy_run_update_script(link):
        ...
        subprocess.Popen([os.path.join(os.getenv('APPDATA'), "vry", "updatescript.bat"), os.path.join(os.getenv('APPDATA'), "vry"), os.getcwd()])
